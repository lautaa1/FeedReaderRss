	...
	public void computeNamedEntities(Heuristic h){
		...
		for (String s: text.split(" ")) {
			if (h.isEntity(s)){
				...
				if (ne == null) {
					// Aquí puedes usar la heurística para obtener clase, subclase y tema
					//String category = h.getCategory(s); // Ejemplo: "persona"
					//String subcategory = null; // Puedes implementar h.getSubcategory(s)
					//String topic = null; // Puedes implementar h.getTopic(s)
